...
ggplot(data, aes( x=Price, y=Brand == "1")) +
  geom_boxplot(color="#6e4d00", fill="#e6c26e") + ylab("Brand: Canon Powershot") + ggtitle("Price for Canon Powershot")+ theme(plot.title = element_text(hjust = 0.5))
```
...
##Question 8: Which Camera Brand is most affordable? [Based on our Dataset]
``` {r}
...
##Question 9: What are the prices of Cameras with Max Resolution more than 4000
```{r}
